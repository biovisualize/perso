...
const iterations = 12  //Number of iterations between the representations
let iteration = 0
...
const activatorProduction = 0.01  //Basic production of the activator
const autocatalysisSaturation = 0.25 //Saturation of autocatalysis
...
const hormoneLife = 1  //Life of the hormone
